...
public class LoghinRegisterController {
    ...
    public String registerUser(@RequestParam String username, @RequestParam String password, @RequestParam String firstName, @RequestParam String lastName, @RequestParam String dateOfBrith, @RequestParam String shortDescription, Model model) {
